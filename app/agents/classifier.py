...
prompt = ChatPromptTemplate.from_messages([
    ("system",
     ...
     "EXAMPLES:\n"
     "Input: 'web service down on lin-us-poc-01'\n"
     "Output: {\"intent\": \"Web service is down\", \"labels\": [\"service_down\"], \"severity\": \"P3\", \"eligibility\": \"auto\", \"confidence\": 0.9}\n"
     "\n"
     "Input: 'high cpu utilization on server01'\n"
     "Output: {\"intent\": \"High CPU utilization detected\", \"labels\": [\"high_cpu\"], \"severity\": \"P3\", \"eligibility\": \"auto\", \"confidence\": 0.9}\n"
     "\n"
     "Input: 'var file system full on host1'\n"
     "Output: {\"intent\": \"Var filesystem is full\", \"labels\": [\"var_filesystem_full\", \"disk_full\"], \"severity\": \"P3\", \"eligibility\": \"auto\", \"confidence\": 0.9}\n"
     "\n"
     "Input: 'server lin-prod-02 is unreachable'\n"
     "Output: {\"intent\": \"Server is unreachable\", \"labels\": [\"server_down\"], \"severity\": \"P1\", \"eligibility\": \"auto\", \"confidence\": 0.9}\n"
     "\n"
     "Input: 'create user jane.doe'\n"
     "Output: {\"intent\": \"Create new user\", \"labels\": [\"create_user\"], \"severity\": \"P3\", \"eligibility\": \"auto\", \"confidence\": 0.9}\n"
     "\n"
